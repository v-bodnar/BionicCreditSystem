...
CREATE TABLE `credit`.`credit_requests` (
  ...
  INDEX `currency_idx` (`id_currency` ASC),
  INDEX `user_idx` (`manager_applied` ASC),
...
(1,
1,
(select User  from mysql.user where User='bodnar'),
'aq1sw2de3',
'Volodymyr',
'Jurijovych',
'Bodnar',
1234567890,
'Ukraine, Kiev, Grigorenko 15',
'bodik@list.ru',
now());
...
(1,
1,
(select User  from mysql.user where User='admin1'),
'123456789',
'admin1',
'admin1',
'admin1',
...
(1,
1,
(select User  from mysql.user where User='admin2'),
'123456789',
'admin2',
'admin2',
'admin2',
...
(1,
1,
(select User  from mysql.user where User='admin3'),
'123456789',
'admin3',
'admin3',
'admin3',
...
(2,
1,
(select User  from mysql.user where User='manager1'),
'123456',
'manager1',
'manager1',
'manager1',
...
(2,
1,
(select User  from mysql.user where User='manager2'),
'123456',
'manager2',
'manager2',
'manager2',
...
(2,
1,
(select User  from mysql.user where User='manager3'),
'123456',
'manager3',
'manager3',
'manager3',
...
(3,
1,
(select User  from mysql.user where User='client1'),
'123',
'client1',
'client1',
'client1',
...
(3,
1,
(select User  from mysql.user where User='client2'),
'123',
'client2',
'client2',
'client2',
...
(3,
1,
(select User  from mysql.user where User='client3'),
'123',
'client3',
'client3',
'client3',
